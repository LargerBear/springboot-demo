...
public class CodeGenerator {
    ...
    public static String packagePath  = "com.example.springbootdemo.";
    /**
     * <p>
     * 读取控制台内容
     * </p>
    ...
    public static void main(String[] args) throws NoSuchFieldException, IllegalAccessException {
        ...
        //数据库路径
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/springboot_test?serverTimezone=UTC&useSSL=false");
        //数据库驱动
...
//        mpg.setTemplateEngine(new BeetlTemplateEngine());
    ...
    public static void customPackagePath(PackageConfig pc,AutoGenerator mpg) throws NoSuchFieldException, IllegalAccessException {
        ...
        packageInfo.put(ConstVal.CONTROLLER, packagePath + moduleName +".controller");
        packageInfo.put(ConstVal.SERVICE, packagePath + moduleName +".service");
        packageInfo.put(ConstVal.SERVICE_IMPL, packagePath + moduleName +".service.impl");
        packageInfo.put(ConstVal.ENTITY, packagePath + moduleName +".entity");
        packageInfo.put(ConstVal.MAPPER, packagePath + moduleName +".mapper");
